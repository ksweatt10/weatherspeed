...
Tables:
  market_timing   — historical record of when each event was created & opened
  bid_log         — every NO bid we placed (or would have in dry_run)
  first_bid_log   — tracking whether we were first to place a bid
"""
